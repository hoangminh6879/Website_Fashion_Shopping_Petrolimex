      ...
      <div className="container mx-auto px-4 py-8 mt-44">
        ...
        <div className="bg-gradient-to-r from-black via-gray-900 to-black rounded-3xl p-12 text-center shadow-2xl border border-amber-500/30 mb-12 relative overflow-hidden group">
           ...
           <div className="relative z-10">
              ...
              <p className="text-amber-500/80 font-black uppercase tracking-[0.5em] text-xs"><AutoText text="Cơ hội cuối cùng để sở hữu những ưu đãi độc quyền" /></p>
           </div>
        </div>
        ...
        {loading ? (
          <div className="py-20 text-center">
             ...
             <p className="mt-4 font-black uppercase text-gray-400 text-[10px] tracking-widest"><AutoText text="Đang săn tìm deal hời cho bạn..." /></p>
          </div>
        ) : products.length > 0 ? (
              ...
              >
                ...
                <div className="flex justify-between items-end">
                   ...
                   <div className="text-right">
                     <p className="text-[9px] font-black uppercase text-amber-600 mb-1"><AutoText text="Chỉ còn" /> {product.flashSaleStock} SP</p>
          ...
          <div className="text-center py-24 bg-white rounded-[3rem] shadow-xl border border-gray-100">
             ...
             <h2 className="text-2xl font-black uppercase italic text-gray-900"><AutoText text="Hiện tại không có Flash Sale nào" /></h2>
             <p className="text-gray-400 text-xs mt-2 uppercase font-bold tracking-widest"><AutoText text="Hãy quay lại sau nhé!" /></p>
          </div>
        )}
      </div>
    </div>
